...
module Socify
  class HomeController < ApplicationController
    ...
    def front
      @activities = PublicActivity::Activity.joins("INNER JOIN socify_users ON socify_activities.owner_id = socify_users.id").order(created_at: :desc).paginate(page: params[:page], per_page: 10)
    end
